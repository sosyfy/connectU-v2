...
export default function Education() {
  return (
    ...
    <div className="grid p-[1.2rem] mt-2 relative">
        <h1 className='text-[1.2rem] text-textblack-200/70 font-semibold tracking-loose'>Multimendia University</h1>
        <h2 className='text-[1rem]  font-medium mt-1 text-textblack-200'>Course name</h2>
