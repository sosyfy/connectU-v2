    ...
    <>
      <div className="grid h-[10.5rem] w-full bg-zinc-200 drop-shadow-[0_2px_5px_rgba(0,172,255,0.2)] rounded-t-md grid-cols-12 gap-4 lg:gap-16 lg:px-16 pt-3 px-4">
        ...
        <div className="md:col-span-5 col-span-6 lg:col-span-4 h-[12rem] mt-2 bg-white rounded-lg">
          ...
          <img src={user?.userInfo.photo} alt="img" className="rounded-lg w-fit h-max" />
        </div>
        <div className="col-span-6 md:col-span-7 lg:col-span-8 font-roboto">
          <div className="grid text-dimgray">
            <h2 className="text-[1.4rem] font-medium">{user?.userInfo.firstName} {user?.userInfo.lastName}</h2>
      ...
      <div className="flex justify-end h-[4rem] box-border w-full">
        <div className="flex items-center justify-around lg:justify-start lg:gap-20 w-[55%] border-b-2 stats border-dimgray/20 fot-roboto text-dimgray/90">
