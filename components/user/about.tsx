    ...
    return (
        <section className='pb-2 bg-white rounded-lg shadow border-dimgray'>
            ...
            <div className="grid p-[1.2rem] mt-2 relative">
                <div className="">
                    <p className='mt-3 text-dimgray text-[1.08rem] font-normal'> Lorem ipsum dolor sit amet consectetur adipisicing elit. Nam ut animi, alias quisquam magni laboriosam reprehenderit corporis. Sint, est eos. Lorem ipsum dolor sit amet consectetur. </p>
                </div>
