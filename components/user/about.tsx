...
export default function About({ user, loggedInUser , token  }: Props) {
    const [aboutData, setAboutData] = useState<string>(user?.about)
                ...
                <div className="flex items-center justify-between">
                    ...
                    {loggedInUser?._id === user?._id && (
                        <div className="flex items-center gap-2 icons">
                            <button onClick={() => openEditModal(aboutData)} className="grid p-2 rounded-full focus:outline-none hover:bg-zinc-200 place-content-center">
