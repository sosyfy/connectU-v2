export default function OneForumLoadingSkeleton() {
  return (
    <div className="relative w-full col-span-12 lg:col-span-8 md:col-span-8 animate-pulse">
      ...
      <div className="rounded-lg bg-white w-full flex flex-col p-[1.25rem] mb-8 box-border items-start justify-start gap-[1.25rem] mt-8">
        ...
        <div className="self-stretch border-y py-3 border-dimgray/10 flex flex-row items-start justify-start gap-[0.63rem] text-[1.25rem]">
          ...
          <div className="h-[3.5rem] flex flex-col items-start justify-center">
            ...
            <div className="rounded-lg h-[1.3rem] mt-2 w-[7rem] bg-slate-100" />

            <div className="flex mt-2 md:hidden">
              <div className="rounded-lg h-[1.3rem] w-[6rem] bg-slate-100" />
            </div>
          </div>
      ...
      <div className="rounded-lg h-[1.8rem] my-4 w-full bg-slate-200" />
      ...
      {Array(4)
        ...
        .map((_, index) => (
          <div
            key={index}
            className="self-stretch overflow-hidden flex flex-col bg-slate-50 p-[1.25rem] items-start justify-start gap-[1.25rem]"
          >
            <div className="self-stretch flex flex-row items-start justify-start gap-[0.63rem] text-[1.25rem]">
              <div className="rounded-lg my-4 relative w-[3.5rem] h-[3.5rem] shrink-0 object-cover bg-slate-100" />

              <div className="flex-1 h-[3.5rem] gap-2 flex flex-col items-start justify-center">
                <div className="rounded-lg h-[1.8rem] w-[6rem] bg-slate-100" />
                <div className="rounded-lg h-[1.8rem] w-[6rem] bg-slate-100" />
              </div>
              <div className="flex flex-row items-center justify-start">
                <div className="rounded-lg h-[1.3rem] my-4 w-[4rem] bg-slate-100" />
              </div>
            </div>

            <div className="rounded-lg h-[1.2rem] mt-2 my-2 w-full bg-slate-100" />
            <div className="rounded-lg h-[1.2rem] my-2 w-full bg-slate-100" />
            <div className="rounded-lg h-[1.2rem] my-2 w-full bg-slate-100" />

            <div className="rounded-lg h-[1.2rem] my-2 w-[4rem] bg-slate-100" />
          </div>
        ))}
    </div>
  );
