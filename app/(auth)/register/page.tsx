            ...
            <div className="flex items-center justify-center h-screen md:px-12">
                <div className="px-5 md:px-8 bg-white w-full sm:w-[24rem] md:h-fit md:mx-auto h-screen md:rounded-xl">
                    <div className="relative py-16 md:py-8 text-left text-[0.88rem] text-black font-roboto">
                        ...
                        <h1 className="absolute md:top-[1rem] top-6 text-[1.88rem] tracking-[-0.01em] leading-[130%] font-serif">
                            Create Account
                        </h1>
                        <RegisterForm />
                        <p className="mt-16 font-serif font-semibold text-center text-dimgray">
                            ...
                            <span className="ml-2 text-black font-roboto">
                                <a href="#" className="font-semibold decoration-transparent"> Log in</a>
                            </span>
                        </p>
                    </div>
                </div>
